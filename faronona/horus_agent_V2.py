...
#  python main.py -ai0 ./faronona/horus_agent_V2.py -ai1 ./faronona/horus_agent_w.py -s 1 -t 5
...
class AI(FarononaPlayer):
    ...
    def play(self, state, remain_time):
        ...
        def demarage_def(state, player):
            ...
            if((state.get_latest_player()== opp_val) ) and ((at == (1,5) and (to == (2,4)))):
        ...
        def best_move (stated , player, moves): # à optimiser ou créer une autre fonction de checking 
            ...
            if len(z) != 0:
                if len (z) == 1 :
                    ...
                    print("#####...........###############")
                    acti = AI_AlphaBeta(depth= 3, startState=state ,player = self.position , chass= z)
                    return acti
            else:
                print("#####..... SUICIDE......###############")
